...
-- Dùng lệnh SELECT để xem / in dư liệu từ table , cũng hiển thị dưới dạng table
-- Cú pháp chuẩn : SELECT  * FROM<TÊN-TABLE>
-- * đại diện cho việc tui muốn lấy all of colums 
--Cú pháp mở rộng:
...
-- từ từ cập nhât sau. Ví dụ sv kí tên vào danh sách thi , cột điểm ngay lúc kí tên 
